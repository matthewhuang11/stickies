...
export function TagPopover({ tags, currentTagIds = [], onToggle, onCreate, onDelete, onClose }) {
    ...
    <>
      ...
      >
        <div className="p-4 pb-8 sm:pb-4">
              ...
              <div className="flex flex-wrap gap-1.5">
                {tags.map(tag => {
                  ...
                  return (
                    <button
                      key={tag.id}
                      className="flex items-center gap-1 rounded-full pl-2.5 pr-1 py-0.5 text-[12px] font-medium transition-all hover:opacity-90"
                      style={{
          ...
          <div className={tags.length > 0 ? 'border-t border-gray-100 pt-4' : ''}>
